...
class relecart():
    ...
    def register_tables(self):
        self.node.createOrReplaceTempView("node")
        self.field_data_field_test_day_click.createOrReplaceTempView("field_data_field_test_day_click")
        self.field_data_field_new_clicks.createOrReplaceTempView("field_data_field_new_clicks")
        self.field_data_field_state.createOrReplaceTempView("field_data_field_state")
        self.field_data_field_campaign.createOrReplaceTempView("field_data_field_campaign")
        self.field_data_field_product_group.createOrReplaceTempView("field_data_field_product_group")
        self.field_data_field_product_clicked.createOrReplaceTempView("field_data_field_product_clicked")
        self.field_data_field_max_cpc_new.createOrReplaceTempView("field_data_field_max_cpc_new")
        self.field_data_field_product_price_true.createOrReplaceTempView("field_data_field_product_price_true")
        self.field_data_field_product_url_true.createOrReplaceTempView("field_data_field_product_url_true")
        self.field_data_field_product_image_url_true.createOrReplaceTempView("field_data_field_product_image_url_true")
        ...
        self.impression.createOrReplaceTempView("impression")
        self.product_group.createOrReplaceTempView("product_group")
        self.product.createOrReplaceTempView("product")
        self.field_data_field_state.createOrReplaceTempView("field_data_field_state")
        self.clicks.createOrReplaceTempView("clicks")
        self.campaign.createOrReplaceTempView("campaign")
